package Android.TestCollection.Earband.view_model
...
class MainViewModel @Inject constructor(
    ...
    var sortOrder: String = AudioSortOrder.AUDIO_DEFAULT
    ...
    private fun loadAudiosFromLocal(): List<Audio> {
        return audioRepository.audios(sortOrder)
    }
    ...
    fun getAppUtility() {
        viewModelScope.launch(Dispatchers.IO) {
            ...
            if (appUtility == null) {
                ...
                val newUtil = Utility(0, 0, AudioSortOrder.AUDIO_DEFAULT).toEntity()
